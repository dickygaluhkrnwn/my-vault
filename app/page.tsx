...
export default function Home() {
    ...
    return (
      <div className={`min-h-screen ${THEME.bg} flex items-center justify-center font-mono p-4`}>
        <div className="w-full max-w-md space-y-2">
            ...
            <div 
                ref={scrollRef}
                className="h-64 bg-slate-900/50 border border-slate-800 rounded p-4 overflow-y-auto font-mono text-xs md:text-sm text-green-400 shadow-inner custom-scrollbar"
            >
                {bootLogs.map((log, i) => (
  ...
  return (
    <div className={`min-h-screen ${THEME.bg} flex items-center justify-center font-mono relative overflow-hidden`}>
      ...
      {/* Content Container */}
      <div className={`w-full max-w-md p-8 rounded-xl border ${THEME.border} bg-slate-900/80 backdrop-blur-md relative z-10 ${THEME.glow} animate-in zoom-in-95 duration-500`}>
        ...
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <h2 className="text-2xl font-bold tracking-widest text-cyan-100 uppercase">
            System Access Portal
          </h2>
          <p className="mt-1 text-xs text-slate-500 tracking-wider">
            ...
            <div className="group">
              ...
              <div className={`flex items-center ${THEME.inputBg} border border-slate-700 rounded p-2 focus-within:border-cyan-500/70 focus-within:shadow-[0_0_10px_rgba(6,182,212,0.2)] transition-all`}>
                ...
                <input
                  ...
                  className="bg-transparent border-none outline-none text-slate-200 text-sm w-full placeholder:text-slate-700 font-mono"
            ...
            <div className="group">
              ...
              <div className={`flex items-center ${THEME.inputBg} border border-slate-700 rounded p-2 focus-within:border-cyan-500/70 focus-within:shadow-[0_0_10px_rgba(6,182,212,0.2)] transition-all`}>
                ...
                <input
                  ...
                  className="bg-transparent border-none outline-none text-slate-200 text-sm w-full placeholder:text-slate-700 tracking-widest font-mono"
                  placeholder="••••••••"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="text-slate-600 hover:text-cyan-400 transition-colors px-2 text-xs font-bold uppercase"
                >
        ...
        {/* Footer */}
        <div className="mt-8 pt-4 border-t border-slate-800 flex justify-between text-[10px] text-slate-600 font-mono">
